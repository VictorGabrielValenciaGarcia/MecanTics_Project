...
<nav class="navbar navbar-expand backbarsup sticky-top ">
                    ...
                    <div class="container">
                        ...
                        <form method="POST" action="/register">
                            ...
                            <div class="mb-1 row">
                                <label for="inputName" class="col-sm-1-12 col-form-label"></label>
                                <div class="col-sm-1-12">
                                    <input type="text" class="form-control" name="correo_personal" id="correo_personal" value="{{ old('correo_personal') }}" placeholder="Correo empresarial">
                            ...
                            <div class="row">
                                <label for="inputName" class="col-sm-1-12 col-form-label"></label>
                                <div class="col-sm-1-12">
                                    <input type="password" class="form-control" name="verificador" id="verificador" placeholder="Clave de autorización de registro">
                                @error ('verificador')
                            ...
                            <input type="checkbox" name="" id="" onclick="showPasswordCC();"> <span  class="showpass"> Mostrar contraseñas y claves</span>
    ...
    <nav class="navbar navbar-expand-lg backbarinf">
        <div class="container-fluid text-center">
            ...
            <div class="col-6 offset-3 text-center regadm">
                <button class="btn regadm">
                <a class="regadm" href="/register/3">
                    <img src="{{asset('Img/large.png')}}" height="40px" width="auto" class="mt-1 mb-1">
                </a>
                </button>
            </div>
