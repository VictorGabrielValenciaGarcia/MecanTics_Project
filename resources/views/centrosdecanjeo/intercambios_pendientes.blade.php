...
@auth
    ...
    @if (Auth::user()->tipo == 'CENTRO DE CANJEO')
        ...
        <div class="container-fluid text-center mt-5 justify-content-center aling-items-center" >
            ...
            <h1 class="Titles2ADM mb-1 mt-3 gren">Intercambios Pendientes</h1>
            ...
            <div class="mb-2 mt-3 text-center">
                ...
                <div class="row mt-4 mb-3">
                    ...
                    <div class="col-6 mb-3">
                        ...
                        <a class="btn btn-primary p-1 widthbut-estados botones-admi-listas" href="/usuarios/intercambios/realizados" role="button">
        ...
        @else
            ...
            <div class="p-5 noproducbg  offset-1 col-10 mt-3 card">
                <div class="container">
                    <h1 class="noproducbgletter text-center">Así se hace!!</h1>
                    <h2 class="noproducbgletter text-center">No hay ningun intercambio pendiente por realizar</h2>
